...
class SidebarEditorAccommodations extends Component {
	constructor(props) {
		super(props);
	...
	render() {
		...
		return (
			<Fragment>
				<Group>
					<h3>Število nastanitev za prikaz</h3>
				...
				<Group>
					<h3>Razvrsti nastanitve glede na:</h3>
					<Dropdown
						color="dark"
						handleClick={this.setSortingType}
						possibilities={{
							numOfBeds: "Kapaciteta namestite",
